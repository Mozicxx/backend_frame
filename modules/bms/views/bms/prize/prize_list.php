...
<div class="mini-fit">
    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true"
         url="<?php echo URL::site("bms/prize/drawgift", TRUE) . "?method=list"; ?>"  idField="id" multiSelect="true" pageSize="20"
         >
        <div property="columns">
            ...
            <div field="rate" width="60" headerAlign="center" allowSort="true">中奖概率</div>            
            <div field="test_imei" width="200" headerAlign="center" allowSort="true">测试用户</div>
...
<script type="text/javascript">
    ...
    function edit() {
        ...
        if (row) {
            mini.open({
                url: "<?php echo URL::site("bms/prize/drawgift/edit", TRUE); ?>",
                title: "编辑抽奖礼品", width: 640, height: 320,
                onload: function() {
    ...
    var Status = [{id: "score", text: '积分'}, {id: "custom", text: '自定义'},{id: "gift", text: '实物'},{id: "gamecode", text: '游戏码'}];
