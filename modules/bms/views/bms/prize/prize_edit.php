    ...
    <div style="padding:5px">
        <fieldset style="border:solid 1px #aaa;padding:3px;">
            ...
            <table width="100%">
                ...
                <tr>
                    <td>奖品类型</td>
                    <td colspan="3"><input name="gift_type" class="mini-combobox"  data="[{id:'score',text:'积分'},{id:'custom',text:'自定义'},{id:'gift',text:'实物'},{id:'gamecode',text:'游戏码'}]"/></td>
                </tr>
                <tr>
                    <td>中奖概率</td>
                    <td colspan="3"><input name="rate" class="mini-textbox" width="80" required="true"/></td>
                </tr>
                <tr class="filed">
                    <td>图标</td>
                    <td colspan="2">
                ...
                <tr>
                    <td>测试用户</td>
                    <td colspan="3"><input name="test_imei" class="mini-textbox" style="width: 80%"/></td>
                </tr>
...
<script type="text/javascript">
    ...
    function SaveData() {
        ...
        $.ajax({
            url: "<?php echo URL::site("bms/prize/drawgift", TRUE) . "?method=save"; ?>",
            type: 'post',
            data: {data: json},
            cache: false,
    ...
    function SetData(data) {
        if (data.action === "edit") {
            ...
            $.ajax({
                url: "<?php echo URL::site("bms/prize/drawgift", TRUE) . "?method=get&id="; ?>" + data.id,
                cache: false,
                success: function(text) {
