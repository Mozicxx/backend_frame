...
<div class="mini-fit">
    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true"
         url="<?php echo URL::site("bms/finance/bill", TRUE) . "?method=list"; ?>"  idField="id" multiSelect="true">
        <div property="columns">
            ...
            <div field="money" width="120" headerAlign="center" allowSort="true">开票金额</div>
            <div field="description" width="120" headerAlign="center" allowSort="true">开票内容</div>
            <div field="bill_type" width="120" headerAlign="center" allowSort="true">开票类型</div>
            <div field="company" width="120" headerAlign="center" allowSort="true">开票公司</div>
            ...
            <div field="write_date" width="120" headerAlign="center" allowSort="true">开票日期</div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function add() {
        ...
        mini.open({
            url: "<?php echo URL::site("bms/finance/bill/edit", TRUE); ?>",
    ...
    function remove() {
        ...
        if (rows.length > 0) {
            if (confirm("确定删除选中记录？")) {
                ...
                $.ajax({
                    url: "<?php echo URL::site("bms/finance/bill", TRUE) . "?method=delete&id="; ?>" + id,
