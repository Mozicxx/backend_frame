...
<div class="mini-fit">
    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true"
         url="<?php echo URL::site("bms/ad/receivable", TRUE) . "?method=list"; ?>"  idField="id" multiSelect="true" pageSize="20">
        <div property="columns">
            <div type="checkcolumn" ></div>
            <div field="closing_date" width="120" headerAlign="center" allowSort="true">应收月份</div>
...
<script type="text/javascript">
    ...
    grid.load();
    grid.sortBy("closing_date", "desc");

    function add() {

        mini.open({
            url: "<?php echo URL::site("bms/ad/receivable/edit", TRUE); ?>",
            title: "录入广告", width: 600, height: 480,
            onload: function() {
    ...
    function remove() {
        ...
        if (rows.length > 0) {
            if (confirm("确定删除选中记录？")) {
                ...
                $.ajax({
                    url: "<?php echo URL::site("bms/ad/receivable", TRUE) . "?method=delete&id="; ?>" + id,
