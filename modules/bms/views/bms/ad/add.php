...
<div class="mini-fit">
    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" allowResize="true"
         url="<?php echo URL::site("bms/ad/add", TRUE) . "?method=list"; ?>"  idField="id" multiSelect="true" pageSize="20"
         >
        <div property="columns">
            ...
            <div field="quota" width="120" headerAlign="center" allowSort="true">投放总量</div>
            <div field="day_quota" width="120" headerAlign="center" allowSort="true">每日计划投放</div>
            ...
            <div field="end_date" width="100" headerAlign="center" allowSort="true">结束时间</div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function add() {
        ...
        mini.open({
            url: "<?php echo URL::site("bms/ad/add/edit", TRUE); ?>",
            title: "录入广告", width: 720, height: 660,
            onload: function() {
    ...
    function edit() {
        ...
        if (row) {
            mini.open({
                url: "<?php echo URL::site("bms/ad/add/edit", TRUE); ?>",
                title: "编辑广告", width: 720, height: 660,
                onload: function() {
                    var iframe = this.getIFrameEl();
    ...
    function remove() {
        ...
        if (rows.length > 0) {
            if (confirm("确定删除选中记录？")) {
                ...
                $.ajax({
                    url: "<?php echo URL::site("bms/ad/add", TRUE) . "?method=delete&id="; ?>" + id,
