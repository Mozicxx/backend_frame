                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input name="roles" class="mini-checkboxlist" repeatItems="5" repeatLayout="table"
                               ...
                               url="<?php echo URL::site("bms/data/adminroles", TRUE); ?>" />
                    </td>
                </tr>
            </table>
        </fieldset>
...
<script type="text/javascript">
    ...
    function SaveData() {
        ...
        $.ajax({
            url: "<?php echo URL::site("bms/config/manager", TRUE) . "?method=save"; ?>",
            type: 'post',
            data: {data: json},
            cache: false,
    ...
    function SetData(data) {
        if (data.action === "edit") {
            ...
            $.ajax({
                url: "<?php echo URL::site("bms/config/manager", TRUE) . "?method=get&id="; ?>" + data.id,
                cache: false,
                success: function(text) {
